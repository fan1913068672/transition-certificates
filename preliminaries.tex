...
Barrier certificates~\cite{prajna2004safety} and closure certificates~\cite{murali2024closure} are used to LTL properties~\cite{pnueli1977temporal}, respectively. We provide their definitions and related conclusions from prior work.
...
% Our transition certificates share this reachability-blocking principle but operates on the product system $\mathfrak{S} \times \mathcal{A}$, eliminating the need to enumerate simple paths in the NBA from initial state to accepting state. 
