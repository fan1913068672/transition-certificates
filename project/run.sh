...
run_cmd "ex2 PT numeric-test" python -u ex2/test.py --coef-json src/ex2/PT/run_ex2_pt.json --grid-step 0.05
run_cmd "ex2 NNT" python -u src/ex2/NNT/main.py
run_cmd "ex2 NNT test" python -u src/ex2/NNT/test.py
run_cmd "ex2 CC"  python -u src/ex2/CC/main.py
run_cmd "ex2 NCC" python -u src/ex2/NCC/main.py
...
run_cmd "ex3 NNT test" python -u src/ex3/NNT/test.py
run_cmd "ex3 CC"  python -u src/ex3/CC/main.py --mode main --out run_ex3_cc.json
run_cmd "ex3 NCC" python -u src/ex3/NCC/main.py --mode main
