...
python -u src/ex1/NNT/main.py
python -u src/ex1/CC/main.py --out smoke_ex1_cc.json
python -u src/ex1/NCC/main.py --epochs 1 --xi 0.01 --eta 0.01

echo "[smoke] 4) ex2"
python -u src/ex2/PT/main.py --max-iter 20 --grid-step 0.2 --dreal-precision 1e-4 --z3-timeout-ms 5000 --out smoke_ex2_pt.json
python -u ex2/test.py --coef-json src/ex2/PT/smoke_ex2_pt.json --grid-step 0.1
python -u src/ex2/NNT/test.py
python -u src/ex2/CC/main.py
python -u src/ex2/NCC/main.py --epochs 1 --xi 0.01 --eta 0.01
...
python -u src/ex3/NCC/main.py --mode main --epochs 1 --xi 0.01 --eta 0.01
